...
import choko1 from "./../../assets/images/choko1.jpg";
import choko2 from "./../../assets/images/choko2.jpg";
import choko3 from "./../../assets/images/choko3.jpg";
import choko4 from "./../../assets/images/choko4.jpg";
          ...
          <div className="modal-content">
            ...
            <ul>
              {cartItems.map((item, index) => (
                <li key={index}>{"Choko-flex"} - {item.price}70 MAD</li>
